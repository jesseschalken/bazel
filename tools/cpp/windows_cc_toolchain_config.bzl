...
def _get_msvc_artifact_name_patterns():
    return [
        artifact_name_pattern(
...
def _get_mingw_artifact_name_patterns():
    return [
        artifact_name_pattern(
            category_name = "executable",
            prefix = "",
...
def _get_msvc_action_configs(ctx):
